...
* Reduced the complexity of examples, thus decreasing the time
needed to run them below 5s. More complex examples are available
in the reference manual, but won't run when example() is called.
